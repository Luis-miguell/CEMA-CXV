    ...
    <div className="register-container">
      <form onSubmit={handleRegister} className="register-form">
        ...
        <input
          ...
          onInput={e => setUser(user => ({ ...user, name: e.target.value }))}
          required
        />
        ...
        <input
          ...
          onInput={e => setUser(user => ({ ...user, lastName: e.target.value }))}
          required
        />
        ...
        <input
          ...
          onInput={e => setUser(user => ({ ...user, email: e.target.value }))}
          required
        />
        ...
        <input
          ...
          onInput={e => setUser(user => ({ ...user, password: e.target.value }))}
          required
        />
